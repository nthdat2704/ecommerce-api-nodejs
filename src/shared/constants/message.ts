export const MESSAGE = {
  ...
  invalidTokenOrExpired: 'The access token provided is invalid or has expired.',
  invalidCredentials: 'Invalid credentials',
  errorInsert: 'Error occurred while inserting data into the database.',
  errorQuery: 'Error occurred while querying data from the database.',
